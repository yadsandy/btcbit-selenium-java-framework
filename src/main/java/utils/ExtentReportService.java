...
public class ExtentReportService {
    ...
    public static final String EXTENT_FULL_REPORT_DIRECTORY = getConfigValue("extent_full_report_dir","config.properties");
    public static final String REPORT_FILE_NAME_PREFIX = getConfigValue("extent_report_file_name_prefix","config.properties");
    public static final String REPORTER_THEME = getConfigValue("extent_reporter_theme","config.properties");
    public static final String DOCUMENT_TITLE = getConfigValue("extent_document_title","config.properties");
    public static final String REPORT_NAME = getConfigValue("extent_reporter_name","config.properties");
    public static final String PROJECT_NAME = getConfigValue("project_name","config.properties");
    public static final String SCREENSHOTS_DIRECTORY = getConfigValue("extent_screenshots_dir","config.properties");
    public static final String EXECUTOR = getConfigValue("test_executor","config.properties");
